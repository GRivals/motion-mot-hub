        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {pricingData.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="relative h-[500px] perspective-1000 animate-scale-in cursor-pointer"
                ...
                >
                  ...
                  <Card className="absolute w-full h-full backface-hidden rotate-y-180 border-accent/50 bg-accent/5">
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        <h4 className="font-semibold text-sm mb-2 text-primary">Периодичность</h4>
                        <p className="text-sm text-muted-foreground">{item.detailedInfo.frequency}</p>
                      </div>
                      
                      <div>
                        <h4 className="font-semibold text-sm mb-2 text-primary">Длительность</h4>
                        <p className="text-sm text-muted-foreground">{item.detailedInfo.duration}</p>
                      </div>
                      
                      <div>
                        <h4 className="font-semibold text-sm mb-2 text-primary">Необходимые документы</h4>
                      ...
                      <div>
                        <h4 className="font-semibold text-sm mb-2 text-primary">Оборудование</h4>
                        <p className="text-sm text-muted-foreground">{item.detailedInfo.equipment}</p>
                      </div>
