...
const pricingData = [
  {
    ...
    features: [
      ...
      "Стоимость прохождения повторного технического осмотра",
      "От 142 руб",
      "(Цена указана за осмотр одного элемента конструкции транспортного средства)",
    ],
    detailedInfo: {
      ...
      equipment:
        "Современное диагностическое оборудование с автоматизированной системой проверки",
    },
  },
  {
  ...
  },
  {
    ...
    detailedInfo: {
      ...
      documents: [
        "ПТС или СТС",
        "Паспорт владельца",
        "Путевой лист (для коммерческого транспорта)",
      ],
      equipment:
        "Профессиональное оборудование для грузового транспорта с усиленной диагностикой",
    },
  },
];
              ...
              >
                ...
                <span className="font-semibold leading-tight">
                  <span className="hidden sm:inline">
                    Обязательная госпошлина 500₽ – узнать подробнее
                  </span>
            ...
            <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
              <DialogHeader>
                <DialogTitle className="text-2xl">
                  Государственная пошлина за внесение сведений в ЕАИСТО
                </DialogTitle>
                <DialogDescription className="text-base mt-4 space-y-4">
                  <p>
                    <strong>С 1 сентября 2025 г.</strong> вступил в силу
                    Федеральный закон от 31 июля 2025 г. № 271-ФЗ «О внесении
                    изменений в часть вторую Налогового кодекса Российской
                    Федерации», предусматривающий взимание государственной
                    пошлины за внесение сведений в единую автоматизированную
                    информационную систему технического осмотра при оформлении
                    диагностической карты по результатам технического осмотра
                    транспортных средств в размере{" "}
                    <strong className="text-primary">500 рублей</strong>.
                  </p>

                  <p>
                    Государственная пошлина подлежит уплате в отношении каждого
                    из представляемых к осмотру транспортных средств. При этом
                    уплата должна осуществляться по реквизитам территориального
                    органа МВД России, на территории размещения которого
                    осуществляется проведение технического осмотра.
                  </p>

                  <div className="bg-accent/10 p-4 rounded-lg border border-accent/30">
                    <p className="font-semibold mb-2">⚠️ Важно!</p>
                    <p>
                      Необходимо заранее уточнить уникальный присваиваемый номер
                      операции (УПНО), состоящий из 32 цифр, у банка, принявшего
                      уплату, в случае его отсутствия в платежном поручении либо
                      чеке об оплате государственной пошлины. Это необходимо для
                      внесения соответствующей информации в единую
                      автоматизированную информационную систему технического
                      осмотра.
                    </p>
                  </div>

                  <p className="text-sm text-muted-foreground">
                    Федеральный закон от 31 июля 2025 г. № 270-ФЗ «О внесении
                  ...
                  <div className="mt-6">
                    ...
                    <p>
                      ...
                      территории г. Кемерово можно уточнить у наших
                      специалистов.
                    </p>
                  </div>
                </DialogDescription>
                    ...
                    <CardContent>
                      <ul className="space-y-2 sm:space-y-3">
                        {item.features.map((feature, featureIndex) => {
                          // дефолтный класс для обычных пунктов
                          let className =
                            "text-xs sm:text-sm text-muted-foreground";

                          // Большой жирный заголовок по центру (чёрный)
                          if (
                            feature ===
                            "Стоимость прохождения повторного технического осмотра"
                          ) {
                            className =
                              "text-center font-bold text-black text-sm sm:text-base";
                          }

                          // Цена, начинающаяся с "От" — по центру и красная
                          if (feature.trim().startsWith("От")) {
                            className =
                              "text-center text-red-600 font-semibold text-sm sm:text-base";
                          }

                          // Комментарий (описание в скобках) — маленький, курсив, серый
                          if (feature.includes("Цена указана")) {
                            className =
                              "text-center text-muted-foreground text-[10px] italic mt-1";
                          }

                          return (
                            <p key={featureIndex} className={className}>
                              {feature}
                            </p>
                          );
                        })}
