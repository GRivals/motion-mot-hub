    ...
    <footer className="bg-foreground/5 border-t border-border/50 py-8 sm:py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
              ...
              <div className="flex items-start gap-2">
                ...
                <a href="mailto:adekt42avtotex@mail.ru" className="hover:text-primary transition-colors break-all">
          ...
          <div>
            <h3 className="font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Адрес</h3>
            <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
              <div className="flex items-start gap-2">
          ...
          <div>
            <h3 className="font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Режим работы</h3>
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-border/50">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4 text-xs sm:text-sm text-muted-foreground">
            <p className="text-center md:text-left">© 2022 - 2025 АДЕКТ АВТО. Все права защищены.</p>
            <p className="text-center md:text-right">г. Кемерово, Космическая улица, 16а к1</p>
          </div>
        </div>
      </div>
    </footer>
