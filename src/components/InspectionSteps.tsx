...
import { Phone, Car, CreditCard, FileText, CheckCircle2, MessageCircle } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, index) => {
            ...
            return (
              <div
                key={index}
                className="relative h-[320px] cursor-pointer animate-scale-in"
                style={{ 
                  perspective: '1000px',
                ...
                >
                  ...
                  >
                    <CardContent className="p-6">
                      ...
                      <p className="text-xs text-muted-foreground mt-4">Нажмите для подробностей</p>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="h-full flex flex-col justify-center p-6">
                      {index === 0 && (
                        <div className="space-y-3">
                          ...
                          >
                            <a href="https://wa.me/79515852222" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
                          ...
                          <Button 
                            ...
                            onClick={(e) => e.stopPropagation()}
                          >
                            <a href="https://t.me/79515852222" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
                              <MessageCircle className="h-4 w-4" />
                              Telegram
                            </a>
                          </Button>
                          <Button 
                            ...
                            onClick={(e) => e.stopPropagation()}
                          >
                            <a href="tel:+79515852222" className="flex items-center gap-2">
                      ...
                      {index === 1 && (
                        <div className="space-y-3">
                          <h4 className="font-semibold text-center mb-4">Необходимые документы:</h4>
                      ...
                      {index === 2 && (
                        <div className="space-y-4 text-center">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Оплата производится за внесение сведений в единую автоматизированную информационную систему технического осмотра (ЕАИСТО)
                          </p>
                      ...
                      {index === 3 && (
                        <div className="space-y-4">
                          ...
                          <h4 className="font-semibold text-center">Получите карту:</h4>
